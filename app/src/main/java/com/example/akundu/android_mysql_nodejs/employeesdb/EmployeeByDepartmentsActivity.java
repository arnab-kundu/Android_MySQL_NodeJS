...
import com.example.akundu.android_mysql_nodejs.adapter.EmployeeListAdapter;
...
public class EmployeeByDepartmentsActivity extends AppCompatActivity implements ApiResponseListener {
    ...
    public void onResponse(Response response) {
        if (response.api_name == API.EMP_DEPT) {
            ...
            spinner_employee_department.setAdapter(new ArrayAdapter<String>(this, R.layout.support_simple_spinner_dropdown_item, list));
